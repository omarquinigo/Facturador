...
public class JPanelBoletaNueva extends javax.swing.JPanel {
    ...
    void CargarIdBoleta(){
        String nombreBoleta = "BB01-";//valor que siempre tendrá
        try {
            ...
            if(rs.last() == true){
                ...
                String numero_boleta = Metodos.ObtenerUltimosXCaracteres(Id, 8);
                // convierto a entero para sumar +1
                int numero = Integer.parseInt(numero_boleta) + 1;
                String numeroBoleta = String.format("%08d", numero);
                nombreBoleta = nombreBoleta + numeroBoleta;
                id = nombreBoleta;
                jtxtId.setText(id);
                
            }   else {
                nombreBoleta = nombreBoleta + "00000001";
                id = nombreBoleta;
                jtxtId.setText(id);
            }         
            rs.close();
    ...
    public void ArchivoPlanoCAB(){
        ...
        File ap = new File(Rutas.getRutaAP("03", id, "CAB"));
        ...
        if (ap.exists()) {
            ...
            try {
                ...
                String tipo_documento_receptor = "1";//DNI
                String numero_documento_cliente = jtxtNumeroDocumento.getText();//num dni
                String nombre_o_razon_social = jtxtNombreRazonSocial.getText();//nombre
    ...
    public void ArchivoPlanoDET(){
        //se crea archivo con el nombre establecido
        File ap = new File(Rutas.getRutaAP("03", id, "DET"));
        BufferedWriter bufferedWriter;
        if (ap.exists()) {
            Metodos.MensajeError("Error generando archivo\n"
                    + "plano " + id + ".DET:\n"
    ...
    public void ArchivoPlanoTRI(){
        //se crea archivo con el nombre establecido
        File ap = new File(Rutas.getRutaAP("03", id, "TRI"));
        BufferedWriter bufferedWriter;
        if (ap.exists()) {
            Metodos.MensajeError("Error generando archivo\n"
                    + "plano " + id + ".TRI:\n"
    ...
    public void ArchivoPlanoLEY(){
        //se crea archivo con el nombre establecido
        File ap = new File(Rutas.getRutaAP("03", id, "LEY"));
        BufferedWriter bufferedWriter;
        if (ap.exists()) {
            Metodos.MensajeError("Error generando archivo\n"
                    + "plano '" + id + ".LEY':\n"
    ...
    public void ArchivoPlanoACA(){
        //se crea archivo con el nombre establecido
        File ap = new File(Rutas.getRutaAP("03", id, "ACA"));
        BufferedWriter bufferedWriter;
        if (ap.exists()) {
            Metodos.MensajeError("Error generando archivo\n"
                    + "plano '" + id + ".ACA':\n"
    ...
    private void RegistrarBoleta() {
        ...
        try {
            Boleta.RegistrarBoleta(id, idCliente, fecha,
    ...
    private void RegistrarBoletaDet() {
        try {
            ...
            for (int i = 0; i < jtblDetalle.getRowCount(); i++) {
                ...
                String IdBoleta = id;
                Boleta.RegistrarBoletaDet(Id, IdBoleta, Item, Cantidad,
