...
public class JDialogClienteBuscar extends javax.swing.JDialog {
    ...
    public void SeleccionarCliente() {
        ...
        dispose();
        //activamos objetos cabecera boleta
        jpbn.jcbxMoneda.setEnabled(true);
        jpbn.jcbxMedioPago.setEnabled(true);
        jpbn.jbtnBuscar.setEnabled(false);
        // activamos objetos de detalle boleta
        jpbn.jtxtCantidad.setEnabled(true);
        jpbn.jcbxTipoUnidad.setEnabled(true);
        jpbn.jtxtPrecioUnitario.setEnabled(true);
        jpbn.jtxtDescripcion.setEnabled(true);
        jpbn.jbtnAgregar.setEnabled(true);
        //limpio cliente
        id = null;
    }
