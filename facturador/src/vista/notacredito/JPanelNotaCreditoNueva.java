...
public class JPanelNotaCreditoNueva extends javax.swing.JPanel {
    ...
    void CargarComprobante() {
        ...
        try {
            ...
            rs.close();
            CargarIdNotaCredito(tipoComprobante);
    ...
    void CargarIdNotaCredito(String tipoComprobante){
        String nombreNotaCredito;//valor que siempre tendrá
        String x;
        if (tipoComprobante.equalsIgnoreCase("factura")){
            nombreNotaCredito = "FC01-";
            x = "F";
        } else {
            nombreNotaCredito = "BC01-";
            x = "B";
        }
        try {
            ...
            if(rs.last() == true){
                ...
                nombreNotaCredito = nombreNotaCredito + numeroNotaCredito;
                id = nombreNotaCredito;
                jtxtId.setText(id);
            }   else {
                nombreNotaCredito = nombreNotaCredito + "00000001";
                id = nombreNotaCredito;
                jtxtId.setText(id);
            }         
            rs.close();
    ...
    private void CambiarMotivo() {
        ...
        switch (motivo){
            case 0:// seleccione
                ...
                break;
            case 1://Anulación de la operación
                Metodos.LimpiarTabla(jtblDetalle);
                LimpiarCamposDetalle();
                CargarComprobanteDet(idComprobante);
                BloquearCamposDetalle();
                ...
                jtblDetalle.setRowSelectionAllowed(false);
                break;
            case 2://Anulación por error en el RUC
                Metodos.LimpiarTabla(jtblDetalle);
                LimpiarCamposDetalle();
                CargarComprobanteDet(idComprobante);
                BloquearCamposDetalle();
                ...
                jtblDetalle.setRowSelectionAllowed(false);
                break;
            case 3://Corrección por error en la descripción
                Metodos.LimpiarTabla(jtblDetalle);
                LimpiarCamposDetalle();
                CargarComprobanteDet(idComprobante);
                BloquearCamposDetalle();
            ...
            case 8://Bonificación
                ...
                jtblDetalle.setRowSelectionAllowed(true);
                break;
            default://Disminución en el valor
                Metodos.LimpiarTabla(jtblDetalle);
                LimpiarCamposDetalle();
                CargarComprobanteDet(idComprobante);
                BloquearCamposDetalle();
    ...
    public void ArchivoPlanoNOT(){
        ...
        File ap = new File(Rutas.getRutaAP("07", id, "NOT"));
        ...
        if (ap.exists()) {
            ...
            try {
                ...
                String codigo_motivo = Metodos.CodigoTipoNotaCredito(jcbxMotivo);//catalogo 9
    ...
    public void ArchivoPlanoDET(){
        //se crea archivo con el nombre establecido
        File ap = new File(Rutas.getRutaAP("07", id, "DET"));
        BufferedWriter bufferedWriter;
        if (ap.exists()) {
            Metodos.MensajeError("Error generando archivo\n"
                    + "plano " + id + ".DET:\n"
    ...
    public void ArchivoPlanoTRI(){
        //se crea archivo con el nombre establecido
        File ap = new File(Rutas.getRutaAP("07", id, "TRI"));
        BufferedWriter bufferedWriter;
        if (ap.exists()) {
            Metodos.MensajeError("Error generando archivo\n"
                    + "plano " + id + ".TRI:\n"
    ...
    public void ArchivoPlanoLEY(){
        //se crea archivo con el nombre establecido
        File ap = new File(Rutas.getRutaAP("07", id, "LEY"));
        BufferedWriter bufferedWriter;
        if (ap.exists()) {
            Metodos.MensajeError("Error generando archivo\n"
                    + "plano '" + id + ".LEY':\n"
    ...
    public void ArchivoPlanoACA(){
        //se crea archivo con el nombre establecido
        File ap = new File(Rutas.getRutaAP("07", id, "ACA"));
        BufferedWriter bufferedWriter;
        if (ap.exists()) {
            Metodos.MensajeError("Error generando archivo\n"
                    + "plano '" + id + ".ACA':\n"
    ...
    private void RegistrarNotaCreditoDet() {
        try {
            ...
            for (int i = 0; i < jtblDetalle.getRowCount(); i++) {
                ...
                String IdNotaCredito = id;
                NotaCredito.RegistrarNotaCreditoDet(Id, IdNotaCredito, Item, Cantidad,
    ...
    private void initComponents() {
        ...
        jcbxMotivo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-Seleccione-", "Anulación de la operación", "Anulación por error en el RUC", "Corrección por error en la descripción", "Descuento global", "Descuento por item", "Devolución total", "Devolución por item", "Bonificación", "Disminución en el valor" }));
