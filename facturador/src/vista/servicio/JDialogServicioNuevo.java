...
public class JDialogServicioNuevo extends javax.swing.JDialog {
    
    static ResultSet rs;

    public JDialogServicioNuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        configurarVentana();
    }
    ...
    boolean existeServicio(String codigo){
            ...
            if (existeServicio(codigo) == true) {
                ...
                try {
                    ...
                    if(precio2.equalsIgnoreCase(""))
                        precio2 = "0.00";
                    Servicio.Registrar(codigo, descripcion,
                            precio1, precio2, estado);
                    dispose();
                } catch (SQLException ex) {
                    Logger.getLogger(JDialogServicioNuevo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogServicioNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogServicioNuevo dialog = new JDialogServicioNuevo(new javax.swing.JFrame(), true);
