...
public class JDialogServicioEditar extends javax.swing.JDialog {
    
    static String id;
    static ResultSet rs;

    public JDialogServicioEditar(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
        configurarVentana();
        cargarServicio(id);
    ...
    boolean existeServicio(String codigo, String id){
            ...
            if (existeServicio(codigo, id) == true) {
                ...
                try {
                    ...
                    if(precio2.equalsIgnoreCase(""))
                        precio2 = "0.00";
                    Servicio.Actualizar(id, codigo, descripcion,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogServicioEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogServicioEditar dialog = new JDialogServicioEditar(new javax.swing.JFrame(), true, id);
