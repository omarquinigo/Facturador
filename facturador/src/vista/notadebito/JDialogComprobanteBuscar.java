...
public class JDialogComprobanteBuscar extends javax.swing.JDialog {
    ...
    public void SeleccionarFactura() {
        ...
        jpndn.jcbxMotivo.setEnabled(true);
        jpndn.jbtnBuscar.setEnabled(false);
        // activamos objetos de detalle factura
        jpndn.jtxtCantidad.setEnabled(true);
        jpndn.jcbxTipoUnidad.setEnabled(true);
        jpndn.jtxtPrecioUnitario.setEnabled(true);
        jpndn.jtxtDescripcion.setEnabled(true);
        jpndn.jbtnAgregar.setEnabled(true);
        //limpio cliente
        id = null;
    }
