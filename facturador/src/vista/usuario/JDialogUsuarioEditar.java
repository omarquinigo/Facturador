...
public class JDialogUsuarioEditar extends javax.swing.JDialog {
    
    static String id;
    static ResultSet rs;

    public JDialogUsuarioEditar(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
        ConfigurarVentana();
        CargarUsuario(id);
    ...
    void CargarUsuario(String idUsuario) {
        id = idUsuario;
        try {
            ...
            while (rs.next()) {
                ...
                jpfRContrasena.setText(contrasena);
                jcbxRol.setSelectedItem(rol);
            }
            rs.close();
        } catch (Exception e) {
            System.out.println("Error cargando usuario: \n" + e);
            Metodos.mensajeError("Error cargando usuario: \n" + e);
        }
    }
    ...
    private void jbtnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnActualizarActionPerformed
        ...
        if (usuario.equals("")
            ...
            if (contrasena.equalsIgnoreCase(rcontrasena)) {
                try {
                    Usuario.Actualizar(id, usuario, contrasena, rol);
                    dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogUsuarioEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogUsuarioEditar dialog = new JDialogUsuarioEditar(new javax.swing.JFrame(), true, id);
